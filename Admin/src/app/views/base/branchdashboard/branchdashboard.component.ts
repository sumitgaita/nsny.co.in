...
export class BranchDashboardComponent {
  ...
  constructor(private titleService: Title, private dashBoardService: DashBoardService,
    ...
    //this.titleService.setTitle("Branch Dashboard Page");
  ...
  getAllCount() {
    ...
    this.dashBoardService.getAllBranchCount(this.currentUser.id, "SNYWB" + ("000" + this.currentUser.id).slice(-3)).subscribe((res: any) => {
      this.dashboard = res;
      this.spinner.hide();
    });
  }
