...
export class AddStudentComponent {
  ...
  public Idnumber() {
    ...
    this.studentService.branchStudentRegisCount(bcode, likestr).subscribe((res: any) => {
      ...
      if (this.currentUser.isBranch === 'True') {
        this.nssycodeAutogenerated = this.currentUser.mastercode + "/" + new Date().getFullYear() % 100 + "/" + ("000" + count).slice(-3);
      } else {
        this.nssycodeAutogenerated = this.currentUser.centercode + "/" + new Date().getFullYear() % 100 + "/" + ("000" + count).slice(-3);
      }
    ...
    this.addStudentForm.get('center_code').setValue(this.currentUser.centercode);
