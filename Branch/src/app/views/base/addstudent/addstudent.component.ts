...
export class AddStudentComponent {
  ...
  onAddStudentSubmit() {
    ...
    const addstudent = {
      ...
      center_code: this.currentUser.isBranch === 'True' ? this.currentUser.id : Number(this.currentUser.branchid),//this.f.center_code.value,
      ...
      subcenter: this.currentUser.isBranch === 'False' ? this.currentUser.id : 0
    }
  ...
  public Idnumber() {
    ...
    if (this.currentUser.isBranch === 'True') {
      likestr = `${environment.branchcode}` + ("000" + st1).slice(-3) + "/" + new Date().getFullYear() % 100 + "/";
    } else {
      likestr = `${environment.branchcode}` + ("000" + st1).slice(-3) + "/" + this.currentUser.centercode + "/" + new Date().getFullYear() % 100 + "/";
    }
   // let likestr = `${environment.branchcode}` + ("000" + st1).slice(-3) + "/" + new Date().getFullYear() % 100 + "/";
    this.studentService.branchStudentRegisCount(bcode, likestr).subscribe((res: any) => {
      ...
      if (this.currentUser.isBranch === 'True') {
        ...
        this.nssycodeAutogenerated = `${environment.branchcode}` + ("000" + st1).slice(-3) + "/" + this.currentUser.centercode + "/" + new Date().getFullYear() % 100 + "/" + ("000" + count).slice(-3);
      }
